...
public class ChatActivity extends AppCompatActivity {
    ...
    private String chat_user_username;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat);
            ...
            chat_user_username = fromUserList.getStringExtra("chat_user_username");
            chat_id = fromUserList.getStringExtra("chat_id");

            setTitle(chat_user_username);

            chat_details = db.collection("chats").document(chat_id);

            registration=db.collection("chats").document(chat_id).collection("messages").orderBy("timestamp")
                                    ...
                                    case ADDED:
                                        ...
                                        if (from.equals(currentUser.getUid())) {
                                            if (messageType.equals("text")) {
                                                ...
                                                sentTextMessage.setText(sentMessageText);
                                            ...
                                            if (messageType.equals("image")) {
                                                ...
                                                sentImageMessageLayoutParams.setMargins(0, 20, 5, 0);
                                            ...
                                            if (messageType.equals("text")) {
                                                ...
                                                receivedTextMessage.setText(receivedMessageText);
                                            ...
                                            if (messageType.equals("image")) {
                                                ...
                                                receivedImageMessageLayoutParams.setMargins(5, 20, 0, 0);
